...
export class InitialDatabase1741158290645 implements MigrationInterface {
    name = 'InitialDatabase1741158290645'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "images" ADD CONSTRAINT "FK_215b1ebfae572b4762c6374e1bf" FOREIGN KEY ("tourCategoryId") REFERENCES "tour_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "images" DROP CONSTRAINT "FK_215b1ebfae572b4762c6374e1bf"`);
