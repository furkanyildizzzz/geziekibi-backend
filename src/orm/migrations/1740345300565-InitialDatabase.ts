...
export class InitialDatabase1740345300565 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."email_templates_key_enum" AS ENUM('USER_WELCOME', 'ADMIN_NEW_USER', 'USER_TOUR_REGISTRATION', 'ADMIN_TOUR_NOTIFICATION', 'USER_CONTACT_FORM', 'ADMIN_CONTACT_NOTIFICATION')`);
