...
export class InitialDatabase1740345300565 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "blogs_tags_tags" ("blogs_id" integer NOT NULL, "tags_id" integer NOT NULL, CONSTRAINT "PK_c5c80295303a602c3250158f0dd" PRIMARY KEY ("blogs_id", "tags_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "tour_services" ADD CONSTRAINT "FK_ed1b275889866644832fa40eba4" FOREIGN KEY ("tour_id") REFERENCES "tours"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_services" ADD CONSTRAINT "FK_1e1cd46e72626852037fd88541e" FOREIGN KEY ("service_id") REFERENCES "services"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_categories" ADD CONSTRAINT "FK_cd7e7a6b10e1153452fae70d093" FOREIGN KEY ("parent_id") REFERENCES "tour_categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_daily_visiting_places" ADD CONSTRAINT "FK_02bb925316c7c5dda7e86ca3731" FOREIGN KEY ("tour_daily_id") REFERENCES "tour_dailies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_dailies" ADD CONSTRAINT "FK_46acf21e68a86f53fb779793595" FOREIGN KEY ("tour_id") REFERENCES "tours"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_prices" ADD CONSTRAINT "FK_4262021ffc6f5bbc97f014d63e1" FOREIGN KEY ("tourDateId") REFERENCES "tour_dates"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_dates" ADD CONSTRAINT "FK_30915c0676b49ea86a03e76ae53" FOREIGN KEY ("tourId") REFERENCES "tours"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tours" ADD CONSTRAINT "FK_facd344449ad26f464e9681c0ab" FOREIGN KEY ("category_id") REFERENCES "tour_categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "blog_categories" ADD CONSTRAINT "FK_ee34e04bfb55942ce65ae758b79" FOREIGN KEY ("parent_id") REFERENCES "blog_categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ADD CONSTRAINT "FK_f15800a81ae8f332420a6d5b8ba" FOREIGN KEY ("tourId") REFERENCES "tours"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ADD CONSTRAINT "FK_fb4f0028b816901df73c2defa8e" FOREIGN KEY ("primaryForTourId") REFERENCES "tours"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ADD CONSTRAINT "FK_96514329909c945f10974aff5f8" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ADD CONSTRAINT "FK_3a2d287b78f86659349f85664e4" FOREIGN KEY ("categoryId") REFERENCES "tour_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ADD CONSTRAINT "FK_25577b35a252e422c2732928131" FOREIGN KEY ("blogCategoryId") REFERENCES "blog_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ADD CONSTRAINT "FK_b73513a1d14c8f2908be932becc" FOREIGN KEY ("blogId") REFERENCES "blogs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ADD CONSTRAINT "FK_7f8e1d228ab22030a05a9454b4e" FOREIGN KEY ("homepageSliderId") REFERENCES "homepage_sliders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_bafb08f60d7857f4670c172a6ea" FOREIGN KEY ("addressId") REFERENCES "user_addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_dailies_daily_paths_tour_daily_paths" ADD CONSTRAINT "FK_5d3e5cd13305c841d3868537801" FOREIGN KEY ("tour_dailies_id") REFERENCES "tour_dailies"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_dailies_daily_paths_tour_daily_paths" ADD CONSTRAINT "FK_be9a102f3ae57ec7bd2fa6f48d4" FOREIGN KEY ("tour_daily_paths_id") REFERENCES "tour_daily_paths"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "tours_tags_tags" ADD CONSTRAINT "FK_14d32753621c875f03d6f32d97b" FOREIGN KEY ("tours_id") REFERENCES "tours"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "tours_tags_tags" ADD CONSTRAINT "FK_43bc37fc2069b820d37fb3ea166" FOREIGN KEY ("tags_id") REFERENCES "tags"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "blogs_tags_tags" ADD CONSTRAINT "FK_abd37453124187f7f887990644c" FOREIGN KEY ("blogs_id") REFERENCES "blogs"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "blogs_tags_tags" ADD CONSTRAINT "FK_3da077225fb0856fd6b0ba4a44d" FOREIGN KEY ("tags_id") REFERENCES "tags"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tour_dailies_daily_paths_tour_daily_paths" DROP CONSTRAINT "FK_be9a102f3ae57ec7bd2fa6f48d4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_dailies_daily_paths_tour_daily_paths" DROP CONSTRAINT "FK_5d3e5cd13305c841d3868537801"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "tour_daily_visiting_places" DROP CONSTRAINT "FK_02bb925316c7c5dda7e86ca3731"`,
    );
    ...
    await queryRunner.query(`DROP TYPE "public"."email_templates_key_enum"`);
