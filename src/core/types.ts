export const INTERFACE_TYPE = {
  ...
  ITourDailyRepository: Symbol.for('ITourDailyRepository'),
  ITourDateRepository: Symbol.for('ITourDateRepository'),
  ITourPriceRepository: Symbol.for('ITourPriceRepository'),
